...
#ifndef ReacMixDeskConnConfig_H
#define ReacMixDeskConnConfig_H
...
namespace ReacMixDeskConnConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 10006;
}

#endif // ReacMixDeskConnConfig_H
