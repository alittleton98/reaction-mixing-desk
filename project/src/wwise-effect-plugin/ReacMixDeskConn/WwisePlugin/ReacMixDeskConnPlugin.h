...
class ReacMixDeskConnPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    ReacMixDeskConnPlugin();
    ~ReacMixDeskConnPlugin();
...
AK_DECLARE_PLUGIN_CONTAINER(ReacMixDeskConn);	// Exposes our PluginContainer structure that contains the info for our plugin
