...
#ifndef ReacMixDeskConnFXParams_H
#define ReacMixDeskConnFXParams_H
...
struct ReacMixDeskConnRTPCParams
{
    AkReal32 fPlaceholder;
};

struct ReacMixDeskConnNonRTPCParams
{
};

struct ReacMixDeskConnFXParams
    : public AK::IAkPluginParam
{
    ReacMixDeskConnFXParams();
    ReacMixDeskConnFXParams(const ReacMixDeskConnFXParams& in_rParams);
    ...
    ReacMixDeskConnRTPCParams RTPC;
    ReacMixDeskConnNonRTPCParams NonRTPC;
};

#endif // ReacMixDeskConnFXParams_H
