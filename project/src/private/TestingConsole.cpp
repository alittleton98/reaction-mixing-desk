...
using TickCallback = bool(TickingObject::*)(float deltaTime); // Function pointer def for a bool Tick(float deltaTime) function signature
...
int main()
{
	...
	// Tick Watchers
	FProfileTimeline* timeline = new FProfileTimeline();
